...
def clean_and_transform_data(raw_file_path=None, clean_file_path=None):
    """
    ...
    if raw_file_path is None:
        raw_file_path = BASE_DIR / 'data' / 'raw_data.csv'
    else:
        raw_file_path = Path(raw_file_path)
    if clean_file_path is None:
        clean_file_path = BASE_DIR / 'data' / 'clean_data.csv'
    else:
